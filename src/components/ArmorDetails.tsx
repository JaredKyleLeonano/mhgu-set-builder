    ...
    <div className="flex-3 flex flex-col ">
      <div className="flex justify-between items-center font-inter text-sm md:text-2xl lg:text-lg xl:text-2xl px-2 py-1 rounded-t-xl bg-[#3A2623] text-white [-webkit-text-stroke:3px#000] [paint-order:stroke_fill]">
        ...
        <div className="flex h-full items-center 2xl:hidden">
          ...
          ></img>
          <img
            className={`${selectedArmor.Torso ? "opacity-100" : "opacity-40"} transition-opacity duration-200 ease-out h-5 w-5 md:h-6 md:w-6 lg:h-5 lg:w-5`}
            src="assets/images/Torso_1.webp"
          ></img>
          <img
            className={`${selectedArmor.Arms ? "opacity-100" : "opacity-40"} transition-opacity duration-200 ease-out h-5 w-5 md:h-6 md:w-6 lg:h-5 lg:w-5`}
            src="assets/images/Arms_1.webp"
          ></img>
          <img
            className={`${selectedArmor.Waist ? "opacity-100" : "opacity-40"} transition-opacity duration-200 ease-out h-5 w-5 md:h-6 md:w-6 lg:h-5 lg:w-5`}
            src="assets/images/Waist_1.webp"
          ></img>
          <img
            className={`${selectedArmor.Legs ? "opacity-100" : "opacity-40"} transition-opacity duration-200 ease-out h-5 w-5 md:h-6 md:w-6 lg:h-5 lg:w-5`}
