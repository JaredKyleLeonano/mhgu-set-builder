  ...
  return (
    <div className="relative flex z-10 mt-1 lg:m-2 w-full justify-center">
      ...
      <div className="relative flex justify-center border-t-2 border-b-2 border-[#e6c98f]/50 gap-2 py-2 px-6 bg-linear-to-b from-[#5a3a2f] to-[#3a2623] ">
        <h1 className="text-lg md:text-3xl lg:text-6xl font-cinzel font-bold tracking-wide bg-linear-to-b from-[#d9b88f] to-[#8c5a2b] bg-clip-text text-transparent">
          MHGU SET BUILDER
        </h1>
        <img
          className="h-6 lg:h-12 rotate-10 "
