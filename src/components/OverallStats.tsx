...
const OverallStats = () => {
  ...
  return (
    <div className="flex lg:block flex-1 flex-col">
      ...
      <div
        className={`flex flex-[0px] overflow-auto flex-col justify-around items-start px-2 text-xs md:text-lg lg:text-base xl:text-lg rounded-b-lg transition-all duration-800 ease-out bg-[#C4B793] border-[#a86f39] focus:outline-none focus:ring-0`}
      >
