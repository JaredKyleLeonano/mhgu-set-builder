    ...
    <div className="flex h-full w-full justify-between gap-4 font-inter">
      <div className="flex flex-col flex-5">
        <div className="flex rounded-t-xl bg-[#3A2623] px-2 py-1">
          <h4 className="flex-1 text-2xl text-white [-webkit-text-stroke:3px#000] [paint-order:stroke_fill]">
            Skill List
          </h4>
          <input
              ...
              <div className="flex justify-center items-center w-full mt-2">
                <button
                  onClick={async () => {
                    ...
                    console.log("FILTERED ARMORS ARE:", filteredArmors);

                    // console.log("ARMORS BY RARITY WORSK:", armorsByRarity);
                    // console.log("ARMORS GROUPED WORKS", groupedByPieceAndType);
                    console.log(
                      "RETRIEVED MAX SKILLS WORKED",
                      retrievedMaxSkills,
                    );
                  }}
      ...
      <div className="flex flex-col flex-4">
        ...
        <div className="flex flex-col justify-between flex-1 bg-black/70 p-4"></div>
      </div>
